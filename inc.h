...
_(FMaterialRenderContext);

/* ---------------------------------------------------------- FMaterial ---------------------------------------------------------- */

_(FMaterial__FTextureLookup);
_(FMaterial);
...
_(FEULAData);
_(UGearboxAccountActions);

/* ---------------------------------------------------------- UFiringBehaviorManager ---------------------------------------------------------- */

_(UFiringBehaviorManager);
...
_(UFireCond_IsPlayerTarget);

/* ---------------------------------------------------------- UFiringPattern ---------------------------------------------------------- */

_(FFiringBehaviorBurstInfo);
_(UFiringPattern);

/* ---------------------------------------------------------- UFirePatt_StrafeOver ---------------------------------------------------------- */

_(UFirePatt_StrafeOver);

/* ---------------------------------------------------------- UFirePatt_ShrinkingCone ---------------------------------------------------------- */

_(UFirePatt_ShrinkingCone);
...
/* ---------------------------------------------------------- UActorFactoryPopulationOpportunityArea ---------------------------------------------------------- */

_(UActorFactoryPopulationOpportunityArea);
...
_(UDefaultInputContextSelector);
...
_(FMissionItemPoolData);
_(UMissionPopulationAspect);
...
/* ---------------------------------------------------------- UPopulationFactoryWillowProjectile ---------------------------------------------------------- */

_(UPopulationFactoryWillowProjectile);

/* ---------------------------------------------------------- UPopulationFactoryInteractiveObject ---------------------------------------------------------- */

_(FPopulatedInteractiveObjectMemento);
_(UPopulationFactoryInteractiveObject);

/* ---------------------------------------------------------- UPopulationFactoryPopulationDefinition ---------------------------------------------------------- */

_(UPopulationFactoryPopulationDefinition);
...
/* ---------------------------------------------------------- UPath_AvoidInEscapableNodes ---------------------------------------------------------- */

_(UPath_AvoidInEscapableNodes);
...
/* ---------------------------------------------------------- UWillowTI_CalcDistances ---------------------------------------------------------- */

_(UWillowTI_CalcDistances);

/* ---------------------------------------------------------- UWillowTI_CalcCanFire ---------------------------------------------------------- */

_(UWillowTI_CalcCanFire);
...
/* ---------------------------------------------------------- UPawnRelevanceUtilityCaching ---------------------------------------------------------- */

_(FRelevanceCacheStruct);
_(UPawnRelevanceUtilityCaching);

/* ---------------------------------------------------------- UPawnRelevanceUtilityFixedCost ---------------------------------------------------------- */

_(FRelevanceUpdateStruct);
_(FRelevanceBucketStruct);
_(UPawnRelevanceUtilityFixedCost);
...
_(UChallengeFeedbackMessage);

/* ---------------------------------------------------------- UFastTravelStationDiscoveryMessage ---------------------------------------------------------- */

_(UFastTravelStationDiscoveryMessage);
...
/* ---------------------------------------------------------- ULocalTrainingDefinitionMessage ---------------------------------------------------------- */

_(ULocalTrainingDefinitionMessage);

/* ---------------------------------------------------------- ULocalInventoryRefreshMessage ---------------------------------------------------------- */

_(ULocalInventoryRefreshMessage);
...
_(FAnimInfo);
_(FAnimBlendInfo);
_(UAnimNodeSequenceBlendBase);

/* ---------------------------------------------------------- UAnimNodeSequenceBlendByAim ---------------------------------------------------------- */

_(UAnimNodeSequenceBlendByAim);
...
_(FChildBoneBlendInfo);
_(UAnimNodeBlendMultiBone);

/* ---------------------------------------------------------- UAnimNodeBlendList ---------------------------------------------------------- */

_(UAnimNodeBlendList);

/* ---------------------------------------------------------- UAnimNodeBlendByBase ---------------------------------------------------------- */

_(UAnimNodeBlendByBase);
...
_(FBranchInfo);
_(FPerBoneMaskInfo);
_(UAnimNode_MultiBlendPerBone);

/* ---------------------------------------------------------- UWillowStaggerAnimNodeBlend ---------------------------------------------------------- */

_(FReferencePoint);
_(FReferencePointComparisonData);
_(UWillowStaggerAnimNodeBlend);
...
_(UAnimNodePlayCustomAnim);

/* ---------------------------------------------------------- UAnimNodeCrossfader ---------------------------------------------------------- */

_(UAnimNodeCrossfader);

/* ---------------------------------------------------------- UAnimNodeAdditiveBlending ---------------------------------------------------------- */

_(UAnimNodeAdditiveBlending);

/* ---------------------------------------------------------- UWillowAnimNode_Simple ---------------------------------------------------------- */

_(UWillowAnimNode_Simple);
...
_(UWillowDmgSource_Rocket);

/* ---------------------------------------------------------- UWillowDmgSource_Grenade ---------------------------------------------------------- */

_(UWillowDmgSource_Grenade);
...
_(UWillowDmgSource_Skill_IgnoreIOs);
...
_(UWillowDmgSource_Shotgun);

/* ---------------------------------------------------------- UWillowDmgSource_Sniper ---------------------------------------------------------- */

_(UWillowDmgSource_Sniper);

/* ---------------------------------------------------------- UWillowDmgSource_Pistol ---------------------------------------------------------- */

_(UWillowDmgSource_Pistol);

/* ---------------------------------------------------------- UWillowDmgSource_MachineGun ---------------------------------------------------------- */

_(UWillowDmgSource_MachineGun);

/* ---------------------------------------------------------- UWillowDmgSource_SubMachineGun ---------------------------------------------------------- */

_(UWillowDmgSource_SubMachineGun);
...
_(UInterpTrackInstHeadTracking);
...
_(FSceneRenderTargets__FSceneRenderTargetItem);
_(FSceneRenderTargets);
...
/* ---------------------------------------------------------- AFluidInfluenceActor ---------------------------------------------------------- */

_(AFluidInfluenceActor);
...
_(AWillowMissionPickupSpawner);

/* ---------------------------------------------------------- AWillowMissionPickupFailsafe ---------------------------------------------------------- */

_(AWillowMissionPickupFailsafe);
...
_(ARB_ConstraintActor);

/* ---------------------------------------------------------- ARB_LineImpulseActor ---------------------------------------------------------- */

_(ARB_LineImpulseActor);
...
_(FSkelMaterialSetterDatum);
_(ASkeletalMeshActorBasedOnExtremeContent);
...
_(F_ModifyHealthParams);
_(AApexDestructibleActor);
...
/* ---------------------------------------------------------- ABlockingMeshReplicatedActor ---------------------------------------------------------- */

_(ABlockingMeshReplicatedActor);
...
/* ---------------------------------------------------------- AStationTeleporterExitPoint ---------------------------------------------------------- */

_(AStationTeleporterExitPoint);
...
_(AStatusEffectReplicatedEmitter);
...
_(ADynamicBlockingVolume__FCheckpointRecord);
_(ADynamicBlockingVolume);
...
_(UBehavior_SetShieldDamageResistanceType);

/* ---------------------------------------------------------- UBehavior_UpdateMissionObjective ---------------------------------------------------------- */

_(UBehavior_UpdateMissionObjective);

/* ---------------------------------------------------------- UBehavior_MatchTransform ---------------------------------------------------------- */

_(UBehavior_MatchTransform);

/* ---------------------------------------------------------- UBehavior_CheckMapChangeConditions ---------------------------------------------------------- */

_(UBehavior_CheckMapChangeConditions);

/* ---------------------------------------------------------- UBehavior_ConvertInstanceDataIntoPhysicsActor ---------------------------------------------------------- */

_(UBehavior_ConvertInstanceDataIntoPhysicsActor);
...
/* ---------------------------------------------------------- UPlayerBehavior_RegisterFastTravelStation ---------------------------------------------------------- */

_(UPlayerBehavior_RegisterFastTravelStation);
...
_(UBehavior_StatusEffectSwitch);
...
/* ---------------------------------------------------------- UUIDataStore_GameState ---------------------------------------------------------- */

_(UUIDataStore_GameState);

/* ---------------------------------------------------------- UUIDataStore_Registry ---------------------------------------------------------- */

_(UUIDataStore_Registry);

/* ---------------------------------------------------------- UUIDataStore_StringBase ---------------------------------------------------------- */

_(UUIDataStore_StringBase);

/* ---------------------------------------------------------- UUIDataStore_InputAlias ---------------------------------------------------------- */

_(FUIInputKeyData);
_(FUIDataStoreInputAlias);
_(UUIDataStore_InputAlias);

/* ---------------------------------------------------------- UUIDataStore_StringAliasMap ---------------------------------------------------------- */

_(FUIMenuInputMap);
_(UUIDataStore_StringAliasMap);
...
_(FPlayerNickMetaData);
_(FRankMetaData);
_(UUIDataStore_OnlineStats);
...
/* ---------------------------------------------------------- ULoadCharacterLobbyGFxObject ---------------------------------------------------------- */

_(ULoadCharacterLobbyGFxObject);

/* ---------------------------------------------------------- UCharacterSelectionCustomizationListGFxObject ---------------------------------------------------------- */

_(UCharacterSelectionCustomizationListGFxObject);

/* ---------------------------------------------------------- UCharacterSelectionGFxObject ---------------------------------------------------------- */

_(UCharacterSelectionGFxObject);

/* ---------------------------------------------------------- UCharacterCustomizationMenuGFxObject ---------------------------------------------------------- */

_(UCharacterCustomizationMenuGFxObject);

/* ---------------------------------------------------------- UCreditsDataProviderGFxObject ---------------------------------------------------------- */

_(UCreditsDataProviderGFxObject);
...
_(FPlayerLineInfo);
_(UWillowGFxColiseumOverlayMovie);

/* ---------------------------------------------------------- UWillowGFxLobbyLoadCharacter ---------------------------------------------------------- */

_(FLoadCharacterData);
_(UWillowGFxLobbyLoadCharacter);
...
_(UCharacterSelectionReduxGFxMovie);
...
_(UAnimNotify_UseBehavior);

/* ---------------------------------------------------------- UAnimNotify_EnableHeadLookAt ---------------------------------------------------------- */

_(UAnimNotify_EnableHeadLookAt);

/* ---------------------------------------------------------- UAnimNotify_EnableHandIK ---------------------------------------------------------- */

_(UAnimNotify_EnableHandIK);

/* ---------------------------------------------------------- UAnimNotify_DialogEvent ---------------------------------------------------------- */

_(UAnimNotify_DialogEvent);

/* ---------------------------------------------------------- UAnimNotify_CustomEvent ---------------------------------------------------------- */

_(UAnimNotify_CustomEvent);
...
_(FAnimSetMeshLinkup);
_(UAnimSet);

/* ---------------------------------------------------------- UInterpTrack ---------------------------------------------------------- */

_(FSupportedSubTrackInfo);
_(FSubTrackGroup);
_(UInterpTrack);
...
_(UInterpGroupDirector);

/* ---------------------------------------------------------- UExpressionEvaluator ---------------------------------------------------------- */

_(UExpressionEvaluator);

/* ---------------------------------------------------------- UPostureStateExpressionEvaluator ---------------------------------------------------------- */

_(UPostureStateExpressionEvaluator);
...
/* ---------------------------------------------------------- UPhysicsStateExpressionEvaluator ---------------------------------------------------------- */

_(UPhysicsStateExpressionEvaluator);

/* ---------------------------------------------------------- UCompoundExpressionEvaluator ---------------------------------------------------------- */

_(UCompoundExpressionEvaluator);

/* ---------------------------------------------------------- UExpressionTree ---------------------------------------------------------- */

_(UExpressionTree);

/* ---------------------------------------------------------- UAICostExpressionEvaluator ---------------------------------------------------------- */

_(UAICostExpressionEvaluator);
...
/* ---------------------------------------------------------- UAttributeExpressionEvaluator ---------------------------------------------------------- */

_(UAttributeExpressionEvaluator);
...
/* ---------------------------------------------------------- UMissionObjectiveWaypointComponent ---------------------------------------------------------- */

_(FMissionObjectiveWaypointData);
_(UMissionObjectiveWaypointComponent);
...
_(UGFxFSCmdHandler_Kismet);

/* ---------------------------------------------------------- UFiringZoneDefinition ---------------------------------------------------------- */

_(UFiringZoneDefinition);

/* ---------------------------------------------------------- UFiringZoneCollectionDefinition ---------------------------------------------------------- */

_(UFiringZoneCollectionDefinition);

/* ---------------------------------------------------------- UFiringBehaviorDefinition ---------------------------------------------------------- */

_(FConditionalPattern);
_(UFiringBehaviorDefinition);

/* ---------------------------------------------------------- UChassisDefinition ---------------------------------------------------------- */

_(UChassisDefinition);

/* ---------------------------------------------------------- UNameListDefinition ---------------------------------------------------------- */

_(UNameListDefinition);

/* ---------------------------------------------------------- UExpressionEvaluatorDefinition ---------------------------------------------------------- */

_(UExpressionEvaluatorDefinition);

/* ---------------------------------------------------------- UWillowLevelTimerDefinition ---------------------------------------------------------- */

_(UWillowLevelTimerDefinition);

/* ---------------------------------------------------------- UFastTravelStationsListOrder ---------------------------------------------------------- */

_(UFastTravelStationsListOrder);

/* ---------------------------------------------------------- UBehaviorVolumeDefinition ---------------------------------------------------------- */

_(UBehaviorVolumeDefinition);

/* ---------------------------------------------------------- UDLCLegacyPlayerClassIdentifierDefinition ---------------------------------------------------------- */

_(FLegacyCustomizationItemData);
_(UDLCLegacyPlayerClassIdentifierDefinition);

/* ---------------------------------------------------------- UPopulationSpawnedActorTagDefinition ---------------------------------------------------------- */

_(UPopulationSpawnedActorTagDefinition);

/* ---------------------------------------------------------- UWillowClanDefinition ---------------------------------------------------------- */

_(FClanMaterialData);
_(FClanSwitchData);
_(UWillowClanDefinition);

/* ---------------------------------------------------------- UAdvancedAxisDefinition ---------------------------------------------------------- */

_(UAdvancedAxisDefinition);
...
_(USpecialMove_PopulationPoint);

/* ---------------------------------------------------------- USpecialMove_Spawned ---------------------------------------------------------- */

_(USpecialMove_Spawned);
...
_(FLootData);
_(ULootConfigurationDefinition);

/* ---------------------------------------------------------- UPopulationFactoryWillowVehicle ---------------------------------------------------------- */

_(FVehicleDefaultCrewStruct);
_(UPopulationFactoryWillowVehicle);
...
_(FAttributeValuePair);
_(FSpecialMoveValuePair);
_(UIAIInterface);

/* ---------------------------------------------------------- UAction_PawnMovementBase ---------------------------------------------------------- */

_(UAction_PawnMovementBase);

/* ---------------------------------------------------------- UBehaviorHelpers ---------------------------------------------------------- */

_(FRelativeDirectionData);
_(FAttachmentLocationData);
_(UBehaviorHelpers);

/* ---------------------------------------------------------- UBehavior_SpawnProjectile ---------------------------------------------------------- */

_(FProjectileBehaviorSequenceStateData);
_(UBehavior_SpawnProjectile);
...
/* ---------------------------------------------------------- UPawnMoveLocationRequest ---------------------------------------------------------- */

_(UPawnMoveLocationRequest);
...
_(FPlayerClassCountOverride);
_(UPlayerClassCountAttributeValueResolver);

/* ---------------------------------------------------------- UManufacturerAttributeValueResolver ---------------------------------------------------------- */

_(FManufacturerSelectorData);
_(UManufacturerAttributeValueResolver);
...
_(UBlackMarketUpgradeAttributeValueResolver);

/* ---------------------------------------------------------- UDamageTypeAttributeValueResolver ---------------------------------------------------------- */

_(FDamageTypeSelectorData);
_(UDamageTypeAttributeValueResolver);
...
/* ---------------------------------------------------------- UMissionObjectiveSetBranchingDefinition ---------------------------------------------------------- */

_(UMissionObjectiveSetBranchingDefinition);

/* ---------------------------------------------------------- UMissionObjectiveSetCollectionDefinition ---------------------------------------------------------- */

_(UMissionObjectiveSetCollectionDefinition);
...
/* ---------------------------------------------------------- UWillowVendingMachineDefinition ---------------------------------------------------------- */

_(UWillowVendingMachineDefinition);
...
/* ---------------------------------------------------------- UControllerAttributeContextResolver ---------------------------------------------------------- */

_(UControllerAttributeContextResolver);

/* ---------------------------------------------------------- UCurrentProficiencySkillAttributeContextResolver ---------------------------------------------------------- */

_(UCurrentProficiencySkillAttributeContextResolver);
...
/* ---------------------------------------------------------- UMissionItemDefinition ---------------------------------------------------------- */

_(UMissionItemDefinition);
...
_(USequenceCondition);

/* ---------------------------------------------------------- USeqCond_CompareBool ---------------------------------------------------------- */

_(USeqCond_CompareBool);
...
_(UGFxEvent_FSCommand);

/* ---------------------------------------------------------- USeqEvent_Touch ---------------------------------------------------------- */

_(USeqEvent_Touch);

/* ---------------------------------------------------------- USeqEvent_EncounterWaveComplete ---------------------------------------------------------- */

_(USeqEvent_EncounterWaveComplete);

/* ---------------------------------------------------------- USeqEvent_RemoteEvent ---------------------------------------------------------- */

_(USeqEvent_RemoteEvent);
...
/* ---------------------------------------------------------- USequenceEventEnableByMission ---------------------------------------------------------- */

_(USequenceEventEnableByMission);
...
/* ---------------------------------------------------------- UGFxAction_CloseMovie ---------------------------------------------------------- */

_(UGFxAction_CloseMovie);
...
/* ---------------------------------------------------------- UWillowSeqAct_QueryTeleporterStatus ---------------------------------------------------------- */

_(UWillowSeqAct_QueryTeleporterStatus);
...
_(UGearboxSeqAct_PopulationOpportunityLink);

/* ---------------------------------------------------------- UWillowSeqAct_AIScriptedAnim ---------------------------------------------------------- */

_(UWillowSeqAct_AIScriptedAnim);
...
/* ---------------------------------------------------------- UWillowSeqAct_InterpMenu ---------------------------------------------------------- */

_(UWillowSeqAct_InterpMenu);

/* ---------------------------------------------------------- USeqAct_PrepareMapChange ---------------------------------------------------------- */

_(USeqAct_PrepareMapChange);

/* ---------------------------------------------------------- USeqAct_WaitForLevelsVisible ---------------------------------------------------------- */

_(USeqAct_WaitForLevelsVisible);
...
/* ---------------------------------------------------------- UWillowAIBlackboardComponent ---------------------------------------------------------- */

_(UWillowAIBlackboardComponent);

/* ---------------------------------------------------------- UWillowAIDenComponent ---------------------------------------------------------- */

_(UWillowAIDenComponent);
...
_(AFogVolumeDensityInfo__FCheckpointRecord);
_(AFogVolumeDensityInfo);

/* ---------------------------------------------------------- AHybridNavigationArea ---------------------------------------------------------- */

_(AHybridNavigationArea);
...
_(FPopulationOptionDenSpawnData);
_(APopulationOpportunityDen);

/* ---------------------------------------------------------- APopulationOpportunityDen_Dynamic ---------------------------------------------------------- */

_(APopulationOpportunityDen_Dynamic);
...
_(UFogVolumeLinearHalfspaceDensityComponent);

/* ---------------------------------------------------------- UFogVolumeSphericalDensityComponent ---------------------------------------------------------- */

_(UFogVolumeSphericalDensityComponent);

/* ---------------------------------------------------------- UFogVolumeConeDensityComponent ---------------------------------------------------------- */

_(UFogVolumeConeDensityComponent);
...
_(UHomingTargetComponent);

/* ---------------------------------------------------------- UCameraConeComponent ---------------------------------------------------------- */

_(UCameraConeComponent);

/* ---------------------------------------------------------- UNavMeshRenderingComponent ---------------------------------------------------------- */

_(UNavMeshRenderingComponent);

/* ---------------------------------------------------------- UWillowDynamicNavMeshConnectionPointRenderingComponent ---------------------------------------------------------- */

_(UWillowDynamicNavMeshConnectionPointRenderingComponent);
...
_(FFoliageInstanceBase);
_(FStoredFoliageInstance);
_(UFoliageComponent);

/* ---------------------------------------------------------- UFluidSurfaceComponent ---------------------------------------------------------- */

_(UFluidSurfaceComponent);

/* ---------------------------------------------------------- USplineComponent ---------------------------------------------------------- */

_(USplineComponent);

/* ---------------------------------------------------------- UWillowFormationComponent ---------------------------------------------------------- */

_(UWillowFormationComponent);
...
_(UApexComponentBase);

/* ---------------------------------------------------------- UApexStaticComponent ---------------------------------------------------------- */

_(UApexStaticComponent);

/* ---------------------------------------------------------- UApexStaticDestructibleComponent ---------------------------------------------------------- */

_(UApexStaticDestructibleComponent);
...
/* ---------------------------------------------------------- UBlockingMeshComponent ---------------------------------------------------------- */

_(UBlockingMeshComponent);

/* ---------------------------------------------------------- UInstancedStaticMeshComponent ---------------------------------------------------------- */

_(FInstancedStaticMeshInstanceData);
_(FInstancedStaticMeshMappingInfo);
_(UInstancedStaticMeshComponent);
...
_(UWillowPreviewComponent);

/* ---------------------------------------------------------- UPerchPreviewComponent ---------------------------------------------------------- */

_(UPerchPreviewComponent);
...
_(UDrawPylonRadiusComponent);

/* ---------------------------------------------------------- UDrawSoundRadiusComponent ---------------------------------------------------------- */

_(UDrawSoundRadiusComponent);
...
_(UInterface_NavigationHandle);

/* ---------------------------------------------------------- UUIListElementCellProvider ---------------------------------------------------------- */

_(UUIListElementCellProvider);

/* ---------------------------------------------------------- UUIDataStoreSubscriber ---------------------------------------------------------- */

_(UUIDataStoreSubscriber);

/* ---------------------------------------------------------- UUIDataStorePublisher ---------------------------------------------------------- */

_(UUIDataStorePublisher);
...
_(UIBodyInfoProvider);

/* ---------------------------------------------------------- UIHitRegionConsumer ---------------------------------------------------------- */

_(UIHitRegionConsumer);
...
_(UIPopulationSpawnPoint);

/* ---------------------------------------------------------- UIHitRegionInfoProvider ---------------------------------------------------------- */

_(UIHitRegionInfoProvider);

/* ---------------------------------------------------------- UIStatusEffectTarget ---------------------------------------------------------- */

_(UIStatusEffectTarget);
...
/* ---------------------------------------------------------- UInterpTrackBehaviors ---------------------------------------------------------- */

_(FBehaviorKeyFrameEventData);
_(UInterpTrackBehaviors);
...
/* ---------------------------------------------------------- UWillowAnimNode_WeaponRecoil ---------------------------------------------------------- */

_(UWillowAnimNode_WeaponRecoil);
...
_(FGestaltAccessoryPartEntry);
_(FGestaltAccessoryGroupEntry);
_(FGestaltAccessoryMeshEntry);
...
_(FFileManagerGeneric);

/* ---------------------------------------------------------- FFileManagerWindows ---------------------------------------------------------- */

_(FFileManagerWindows);
...
/* ---------------------------------------------------------- UVehicleBalanceDefinition ---------------------------------------------------------- */

_(FVehicleGradeModifierData);
_(FVehicleGameStageGradeWeightData);
_(UVehicleBalanceDefinition);
...
/* ---------------------------------------------------------- AResurrectTravelStation ---------------------------------------------------------- */

_(AResurrectTravelStation);
